...
router.post('/sessions/start', validate(sessionSchema), adminController.startSession);
router.post('/sessions/stop', validate(sessionSchema), adminController.stopSession);
